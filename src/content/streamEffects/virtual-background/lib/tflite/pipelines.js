...
RenderingPipeline.prototype.setVirtualBackground = function (sourcePlayback, backgroundConfig, segmentationConfig, canvasRef, backgroundImageRef){
...
RenderingPipeline.prototype.useRenderingPipeline = async function (sourcePlayback, backgroundConfig, segmentationConfig, backgroundImageRef, callback){
	...
	function getPipeline(){
		...
		// 		if(!This.visibilityRenderRequestId){
		// 			console.warn("设置render调用定时器")
		...
		This.setVirtualBackground(sourcePlayback, backgroundConfig, segmentationConfig, canvasRef, backgroundImageRef)
