 ...
 */
class TrackVADEmitter extends EventEmitter {
    /**
     * Constructor.
     *
     ...
     *
     * @param  stream - Target microphone device id.
    ...
    _initializeAudioContext() {
        this._audioSource = this._audioContext.createMediaStreamSource(this._localStream);
