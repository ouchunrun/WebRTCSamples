let tips = {
	...
	"dialog": {
		...
		"Cancel": "取消",
		"close": "关闭",
		"conferenceDisconnectMsg": "请检查你的网络连接。将会在 {{seconds}} 秒后重新连接…",
		...
		"shareYourScreenDisabled": "禁止共享屏幕。",
		"shareYourScreenDisabledForGuest": "访客无法共享屏幕。",
	...
	"inviteDialog": {
		"alertText": "邀请成员失败。",
		"header": "邀请",
		"searchCallOnlyPlaceholder": "输入电话号码",
		"searchPeopleOnlyPlaceholder": "查找成员",
		"searchPlaceholder": "成员或电话号码",
		"send": "发送"
	},
	"inlineDialogFailure": {
		"msg": "貌似出了点问题。",
	...
	"liveStreaming": {
		...
		"changeSignIn": "切换帐号",
		"choose": "选择一个直播流",
		"chooseCTA": "请选择直播选项。您现在以 {{email}} 身份登录。",
	...
	"localRecording": {
		...
		"localRecording": "本地录制中",
		"me": "自己",
		"messages": {
			"engaged": "本地录音被占用。",
			"finished": "会话 {{token}} 录制结束。请将录制的文件发送给主持人。",
			"finishedModerator": "会话 {{token}} 录制结束。本地录制已保存。请要求其他参与者提交他们的录音。",
			"notModerator": "你不是主持人.你不能开启或关闭本地录音"
		},
		"moderator": "管理员",
		"no": "否",
		"participant": "与会者",
		"participantStats": "与会者状态",
		"sessionToken": "会话令牌",
		"start": "开始录制",
		"stop": "停止录制",
		"yes": "是"
	...
	"recording": {
		...
		"signIn": "登录",
		"signOut": "登出",
		"unavailable": "噢！{{serviceName}} 暂时无法使用。我们正在解决此问题。请稍后再试。",
	...
	"videoSIPGW": {
		...
		"busyTitle": "房间服务正忙",
		"errorAlreadyInvited": "{{displayName}} 已被邀请过了",
		"errorInvite": "会议还未开始。请稍后再来。",
		"errorInviteFailed": "我们正在解决问题。请稍后再试。",
		"errorInviteFailedTitle": "邀请 {{displayName}} 失败",
		"errorInviteTitle": "邀请房间错误",
	...
	"welcomepage": {
		...
		"appDescription": "快来使用全队视频通话。您可以邀请任何您认识的人。{{app}} 是一个完全加密，100% 开源的视频会议解决方案。无需注册帐号，无限时免费使用。",
		"audioVideoSwitch": {
			"audio": "语音",
			"video": "视频"
		},
