                                ...
                                createTransaction(self._dbInfo, READ_ONLY, function (err, transaction) {
                                    ...
                                    try {
                                        ...
                                        req.onsuccess = function () {
                                            var value = null;
                                            if (req.readyState === 'done' && req.result !== undefined) {
                                                value = req.result;
                                            }
                                    ...
                                    function driverPromiseLoop() {
                                        while (currentDriverIndex < supportedDrivers.length) {
                                            ...
                                            return self.getDriver(driverName).then(extendSelfWithDriver)["catch"](function (e) {
                                                console.log('OoOoOoOoOoOoOoOOOOOoO %o' + e);
                                                driverPromiseLoop();
                                            });
                                        }
...
// global. It's extended by pulling in one of our other libraries.
                ...
                function debug() {
                    ...
                    if (createDebug.localLogState === true) {
                        ...
                        if (createDebug.keyBuffer.length >= 20) {
                            createDebug.logStorage.setItems(createDebug.keyBuffer.concat(), createDebug.logBuffer.concat());
                    ...
                    createDebug.dbStorage.getItem(createDebug.sessionStorage.dbName).then(function(info) {
                        if (info != null && info !== "[object Object]") { //Todo: figure out why info is [object Object], when dbName is not exisit.
                            ...
                            if (confInfo.confTitle) {
                                infoJson.confTitle = confInfo.confTitle;
                            }
        ...
        function logStorage() {
            try {
                ...
                console.warning("Indexed DB error : %o", e);
                console.info("Disable local log feature");
                saveLocalLogState(false);
            }
        }
