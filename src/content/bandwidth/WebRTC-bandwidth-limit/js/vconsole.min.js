...
!function (e, t) {
    ...
    return function (e) {
        ...
        function p(e, t) {
            ...
            var n = d[d.length - 1];
            if ("top" === e.insertAt) n ? n.nextSibling ? o.insertBefore(t, n.nextSibling) : o.appendChild(t) : o.insertBefore(t, o.firstChild), d.push(t); else if ("bottom" === e.insertAt) o.appendChild(t); else {
        ...
        function m(e, t) {
            ...
            if (t.singleton) {
                ...
                var n = o.css, r = o.sourceMap, i = void 0 === t.convertToAbsoluteUrls && r;
            ...
            var b = 1e3, h = [], g = {}, m = function (e) {
                ...
                return function (e, t) {
                    ...
                    key: "printRepeatLog", value: function () {
                        var e = r.default.one("#" + g._id), t = r.default.one(".vc-item-repeat", e);
        ...
        r = [t, o(9), o(0), o(1), o(11), o(14), o(15), o(16), o(17), o(18), o(19), o(25), o(27), o(31), o(38)], void 0 === (i = "function" == typeof (n = function (o, n, r, i, a, l, c, s, d, u, f, v, p, b, h) {
            ...
            var y = "#__vconsole", _ = function () {
                function e(t) {
                    if (function (e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, e), i.default.one(y)) console.debug("vConsole is already exists."); else {
                        var o = this;
                        ...
                        if (void 0 !== document) "complete" == document.readyState ? c() : i.default.bind(window, "load", c); else l = setTimeout(function e() {
                ...
                return t = e, (o = [{
                    ...
                    key: "_mockTap", value: function () {
                        ...
                        this.$dom.addEventListener("touchstart", function (n) {
                            ...
                            if (!1 === n && t.timeStamp - e < 700 && null != r) {
                                var o = r.tagName.toLowerCase(), i = !1;
                                switch (o) {
                                    case"textarea":
                                        i = !0;
                                        break;
                    ...
                    key: "show", value: function () {
                        if (this.isInited) {
                            var e = this, t = i.default.one(".vc-panel", this.$dom);
                    ...
                    key: "mockAjax", value: function () {
                        ...
                        if (e) {
                            ...
                            t._open = o, t._send = n, window.XMLHttpRequest.prototype.open = function () {
                                var e = this, n = [].slice.call(arguments), r = n[0], i = n[1], a = t.getUniqueID(),
                                    l = null;
                                ...
                                var c = e.onreadystatechange || function () {
                                    ...
                                    if (o.readyState = e.readyState, o.status = 0, e.readyState > 1 && (o.status = e.status), o.responseType = e.responseType, 0 == e.readyState) o.startTime || (o.startTime = +new Date); else if (1 == e.readyState) o.startTime || (o.startTime = +new Date); else if (2 == e.readyState) {
                                        ...
                                        for (var n = e.getAllResponseHeaders() || "", r = n.split("\n"), i = 0; i < r.length; i++) {
                                            var s = r[i];
                                            if (s) {
                                                var d = s.split(": "), u = d[0], f = d.slice(1).join(": ");
                                                o.header[u] = f
                                            }
                                        }
                                ...
                                var e = [].slice.call(arguments), o = e[0], i = t.reqList[this._requestID] || {};
                    ...
                    key: "onChildRemove", value: function (e) {
                        ...
                        if (o) {
                            for (var n = 0; n < e.removedNodes.length; n++) {
                                var r = e.removedNodes[n], i = r.__vconsole_node;
                    ...
                    key: "onChildAdd", value: function (e) {
                        ...
                        if (o) {
                            ...
                            for (var n = 0; n < e.addedNodes.length; n++) {
                                var r = e.addedNodes[n], i = r.__vconsole_node;
