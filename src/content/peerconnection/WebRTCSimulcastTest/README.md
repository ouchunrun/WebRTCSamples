...
function start() {
    ...
    pc.onnegotiationneeded = function () {
        pc.createOffer().then(function (offer) {
            ...
            console.warn('pc.localDescription:', pc.localDescription.sdp)
        }).catch(logError);
    };
...
```
v=0
o=- 3417611617736053838 2 IN IP4 127.0.0.1
s=-
t=0 0
a=group:BUNDLE 0 1
...
a=ice-ufrag:dOPz
a=ice-pwd:YyKushsm4A3CehMT/GR92K9a
a=ice-options:trickle
a=fingerprint:sha-256 A8:13:56:CD:53:03:F4:5A:E0:67:75:18:9B:E0:62:D5:F2:59:EC:37:4B:44:5F:31:52:8B:B2:38:CE:12:9C:E6
a=setup:actpass
a=mid:0
...
a=sendonly
a=msid:- 05c2f805-d7a2-4d11-ba41-52fd5fed7f0d
a=rtcp-mux
...
a=ssrc:3545214502 cname:HVPSP35/AUzKCJk7
a=ssrc:3545214502 msid:- 05c2f805-d7a2-4d11-ba41-52fd5fed7f0d
...
a=sendonly
a=msid:- a89d9f3e-0484-4bba-904c-a4eb3df7d64d
a=rtcp-mux
a=rtcp-rsize
