...
(function() {
    window.getScreenId = function(isWindow,callback) {
        ...
        // sourceId == 'firefox'
        // screen_constraints = {...}
        let source = isWindow ? 'window' : 'screen';
        ...
        if ( (adapter.browserDetails.browser == "ie" || adapter.browserDetails.browser == "safari" ) && adapter.browserDetails.isWebRTCPluginInstalled == true) {
            ...
            if ( source === 'screen' ) {
                 ...
                 //let windowList = window.loadWindows();

                 let windowId = window.selectedWindowId;
                 //let imgBase64 = windowSelect.options[windowSelect.selectedIndex].previewImg64;
        ...
        function onIFrameCallback(event) {
            ...
            let chromeMediaSourceId = event.data;
